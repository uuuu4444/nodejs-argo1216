...
const SUB_PATH = process.env.SUB_PATH || 'sub1216';       // 璁㈤槄璺緞
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http鏈嶅姟璁㈤槄绔彛
const UUID = process.env.UUID || 'f96d6fc9-1fa6-4010-b386-5e5d7da137a0'; // 浣跨敤鍝悞v1,鍦ㄤ笉鍚岀殑骞冲彴杩愯闇€淇敼UUID,鍚﹀垯浼氳鐩�
